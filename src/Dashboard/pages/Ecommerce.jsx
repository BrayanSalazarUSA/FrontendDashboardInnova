...
const Ecommerce = () => {
  ...
  return (
    <div className="m-10 mt-0 md:m-8 p-2 md:p-0 bg-white rounded-3xl">
      <Header
        category={t("dashboard.dashboard-index.home")}
        title={<TextAnimation text={propertyContext.name || ""} />}
      />
      <div className="mt-3 ">
        <div
        ...
        >
          <div className="h-44 rounded-xl w-full lg:w-96 p-8 pt-9 m-3 bg-gray-800/60  bg-no-repeat bg-cover bg-center">
            <div className="flex justify-between items-center py-5">
              <div>
                <p className="p-0 font-bold text-gray-300 ">
                  {t("dashboard.dashboard-index.number-reports")}
                </p>
          ...
          <div className="flex m-3 flex-wrap gap-1 items-">
            <div
              key={1}
              className="bg-white/75 dar:text-gray-200 dark:bg-secondary-dark-bg md:w-52 p-4 pt-9 rounded-2xl"
            >
              <button
                type="button"
                style={{
              ...
              <p className="p-0 text-md text-gray-700 mt-1 ">
                {t("dashboard.dashboard-index.total-cameras")}
              </p>
            </div>
            <div
              key={2}
            ...
            >
              ...
              <p className="p-0 text-md text-gray-700 mt-1 ">
                {t("dashboard.dashboard-index.cameras-on")}
              </p>
            </div>
            <div
              key={3}
            ...
            >
              ...
              <p className="p-0 text-md text-gray-700 mt-1 ">
                {t("dashboard.dashboard-index.cameras-off")}
              </p>
            </div>

            <div
              key={4}
              className="bg-white/75 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-1/4 p-4 pt-9 rounded-2xl"
            >
              <button
                type="button"
                style={{
