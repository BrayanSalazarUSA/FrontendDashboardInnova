        ...
        <>
          <div className="flex justify-center items-start flex-col w-full">
            ...
            <div className="flex flex-row justify-start items-center mt-4 mb-4">
              <img className={`logodash ${showImage} logodash.animate-assembleImage`} src={Logo} alt="Logo" />
              <h1 className="font-extrabold text-xl leading-none text-gray-900">Innova <br/> Monitoring IDS</h1>
            </div>
